...
public class SoapBindingStub extends org.apache.axis.client.Stub implements com.sforce.soap.enterprise.Soap {
    ...
    private void addBindings4() {
            ...
            qName = new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "Fundraiser__c");
            cachedSerQNames.add(qName);
            cls = com.sforce.soap.enterprise.sobject.Fundraiser__c.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "Fundraiser__Feed");
            cachedSerQNames.add(qName);
            cls = com.sforce.soap.enterprise.sobject.Fundraiser__Feed.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    private void addBindings5() {
            ...
            qName = new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "PurchaseOrderLineItems__c");
            cachedSerQNames.add(qName);
            cls = com.sforce.soap.enterprise.sobject.PurchaseOrderLineItems__c.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "Sales_Invoice__c");
            cachedSerQNames.add(qName);
            cls = com.sforce.soap.enterprise.sobject.Sales_Invoice__c.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
