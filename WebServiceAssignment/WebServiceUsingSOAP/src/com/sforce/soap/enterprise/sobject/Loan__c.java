...
public class Loan__c  extends com.sforce.soap.enterprise.sobject.SObject  implements java.io.Serializable {
    ...
    private java.lang.String applicantEmail__c;

    private java.lang.String applicantName__c;

    private com.sforce.soap.enterprise.sobject.User applicantName__r;
    ...
    public Loan__c(
           ...
           java.lang.String applicantEmail__c,
           java.lang.String applicantName__c,
           com.sforce.soap.enterprise.sobject.User applicantName__r,
        ...
        this.applicantEmail__c = applicantEmail__c;
        this.applicantName__c = applicantName__c;
        this.applicantName__r = applicantName__r;
    ...
    /**
     * Gets the applicantEmail__c value for this Loan__c.
     * 
     * @return applicantEmail__c
     */
    public java.lang.String getApplicantEmail__c() {
        return applicantEmail__c;
    }


    /**
     * Sets the applicantEmail__c value for this Loan__c.
     * 
     * @param applicantEmail__c
     */
    public void setApplicantEmail__c(java.lang.String applicantEmail__c) {
        this.applicantEmail__c = applicantEmail__c;
    }


    /**
     * Gets the applicantName__c value for this Loan__c.
     * 
     * @return applicantName__c
     */
    public java.lang.String getApplicantName__c() {
        return applicantName__c;
    }


    /**
     * Sets the applicantName__c value for this Loan__c.
     * 
     * @param applicantName__c
     */
    public void setApplicantName__c(java.lang.String applicantName__c) {
        this.applicantName__c = applicantName__c;
    }


    /**
     * Gets the applicantName__r value for this Loan__c.
     * 
     * @return applicantName__r
     */
    public com.sforce.soap.enterprise.sobject.User getApplicantName__r() {
        return applicantName__r;
    }


    /**
     * Sets the applicantName__r value for this Loan__c.
     * 
     * @param applicantName__r
     */
    public void setApplicantName__r(com.sforce.soap.enterprise.sobject.User applicantName__r) {
        this.applicantName__r = applicantName__r;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.applicantEmail__c==null && other.getApplicantEmail__c()==null) || 
             (this.applicantEmail__c!=null &&
              this.applicantEmail__c.equals(other.getApplicantEmail__c()))) &&
            ((this.applicantName__c==null && other.getApplicantName__c()==null) || 
             (this.applicantName__c!=null &&
              this.applicantName__c.equals(other.getApplicantName__c()))) &&
            ((this.applicantName__r==null && other.getApplicantName__r()==null) || 
             (this.applicantName__r!=null &&
              this.applicantName__r.equals(other.getApplicantName__r()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getApplicantEmail__c() != null) {
            _hashCode += getApplicantEmail__c().hashCode();
        }
        if (getApplicantName__c() != null) {
            _hashCode += getApplicantName__c().hashCode();
        }
        if (getApplicantName__r() != null) {
            _hashCode += getApplicantName__r().hashCode();
        }
    ...
    static {
        ...
        elemField.setFieldName("applicantEmail__c");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "ApplicantEmail__c"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("applicantName__c");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "ApplicantName__c"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("applicantName__r");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "ApplicantName__r"));
